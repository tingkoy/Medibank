// page assets
import media from '../assets/img/4.png';
import qr from '../assets/img/4_qr_ipbar.png';
      ...
      <div class="cont">
        ...
        <div class="head">
          ...
          <div class="cont_title">
            It's pretty bloody awesome really.
          </div>
        </div>
        <div class="cont_med_cntx">
          ...
          <div class="cmc_cntxt_wrap">
            <div class="cmc_cntxt_desc">
              We have a heart pumping, infection fighting, waste reducing, organ feeding, life maintaining liquid superpower pumping through our veins.
              <br/><br/>
              Find out how you can donate yours and help save a life in under an hour.
            </div>
